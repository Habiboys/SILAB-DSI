...
const RubrikGradingModal = ({ isOpen, onClose, submission, tugas, onSave }) => {
    ...
    const calculateTotal = () => {
        ...
        tugas.komponen_rubriks?.forEach((komponen) => {
            ...
            console.log(
                `Komponen ${komponen.id}: nilai=${nilai}, bobot=${komponen.bobot}, max=${komponen.nilai_maksimal}`
            );
            ...
            if (nilai && nilai !== "" && !isNaN(parseFloat(nilai))) {
                ...
                if (nilaiFloat >= 0 && maxFloat > 0 && bobotFloat >= 0) {
                    ...
                    console.log(
                        `  Nilai asli: ${nilaiFloat}, Capped: ${nilaiCapped}`
                    );
                    console.log(
                        `  Persentase: ${nilaiCapped}/${maxFloat} * 100 = ${persentaseNilai}%`
                    );
                    console.log(
                        `  Kontribusi: ${persentaseNilai}% * ${bobotFloat}% = ${kontribusi}%`
                    );
                }
            }
        });
                ...
                {tugas.komponen_rubriks && tugas.komponen_rubriks.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-gray-500">
                        ...
                        <p className="text-sm mt-2">
                            Silakan buat komponen rubrik terlebih dahulu.
                        </p>
                    </div>
                )}
            </div>
