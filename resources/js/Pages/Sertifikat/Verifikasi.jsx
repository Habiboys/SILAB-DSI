                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 w-full max-w-md overflow-hidden">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p
                                    className={`text-sm font-semibold ${valid ? "text-green-800" : "text-red-700"}`}
                                >
                                    {valid
                                ...
                                <p
                                    className={`text-xs mt-0.5 ${valid ? "text-green-600" : "text-red-500"}`}
                                >
                                    {valid
                    ...
                    <div className="px-6 py-5">
                        ...
                        {valid && data ? (
                            ...
                            <p className="text-sm text-gray-500 text-center py-4">
                                Data sertifikat dengan nomor ini tidak
                                ditemukan. Hubungi administrator laboratorium
                    ...
                    <div className="px-6 py-3 bg-gray-50 border-t border-gray-100 text-center text-xs text-gray-400">
                        Diverifikasi oleh SILAB &middot;{" "}
...
function JenisBadge({ jenis }) {
    const map = {
        praktikan: {
            label: "Sertifikat Praktikan",
            cls: "bg-green-100 text-green-800",
        },
        asisten: {
            label: "Sertifikat Asisten",
            cls: "bg-purple-100 text-purple-800",
        },
        kepengurusan: {
            label: "Sertifikat Kepengurusan",
    ...
    return (
        <span
            className={`inline-block text-xs font-semibold px-2.5 py-0.5 rounded ${item.cls}`}
        >
            {item.label}
        </span>
    );
