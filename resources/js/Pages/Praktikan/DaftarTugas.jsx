...
export default function DaftarTugas({
    ...
    const handleSubmit = () => {
        ...
        if (uploadForm.files.length > 0 && validLinks.length > 0) {
            ...
            router.post(
                `/praktikum/tugas/${selectedTugas.id}/pengumpulan`,
                formData,
                {
                    onSuccess: () => {
        ...
        if (confirmAction.action === "cancel") {
            try {
                const response = await fetch(
                    `/praktikum/pengumpulan/${confirmAction.pengumpulanId}/cancel`,
                    {
                        method: "DELETE",
                        headers: {
                ...
                toast.error(
                    "Terjadi kesalahan saat membatalkan pengumpulan tugas"
                );
            }
        }
    };
    ...
    const filteredTugas =
        selectedPraktikum === "all"
            ? tugasPraktikums
            : tugasPraktikums.filter(
                  (t) => t.praktikum_id === selectedPraktikum
              );
                ...
                <div className="p-4 sm:p-6 flex items-center border-b">
                    <div>
                        ...
                        <p className="text-sm sm:text-base text-gray-600">
                            Lihat semua tugas yang tersedia untuk praktikum Anda
                        </p>
                    </div>
                </div>
                        ...
                        {filteredTugas.length === 0 ? (
                            ...
                            <div className="space-y-6">
                                {selectedPraktikum === "all" ? (
                                    ...
                                    Object.entries(tugasByPraktikum).map(
                                        ([praktikumId, tugasList]) => {
                                            const praktikan = praktikans.find(
                                                (p) =>
                                                    p.praktikum_id ===
                                                    praktikumId
                                            );
                                                        ...
                                                        <table className="min-w-full divide-y divide-gray-200">
                                                            ...
                                                            <tbody className="bg-white divide-y divide-gray-200">
                                                                {tugasList.map(
                                                                    (tugas) => {
                                                                        const pengumpulan =
                                                                            riwayatPengumpulan.find(
                                                                                (
                                                                                    r
                                                                                ) =>
                                                                                    r.tugas_praktikum_id ===
                                                                                    tugas.id
                                                                            );
                                                                        const status =
                                                                            pengumpulan
                    ...
                    <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md mx-4">
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-sm text-gray-600">
                                Praktikum:{" "}
                                {selectedTugas?.praktikum?.mata_kuliah ||
                                    "Nama Praktikum Tidak Diketahui"}
                            </p>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                                Format: PDF, DOC, DOCX, ZIP, RAR (Max: 10MB per
                                file)
                            </p>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                                Masukkan link ke Google Drive, GitHub, atau
                                platform lainnya
                            </p>
                        </div>
                        ...
                        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
                            <p className="text-sm text-blue-800">
                                <strong>Info:</strong> Anda dapat mengumpulkan
                                file, link, atau keduanya sekaligus. Minimal
                                harus ada satu file atau satu link.
                            </p>
                        </div>
