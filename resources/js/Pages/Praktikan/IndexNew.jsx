...
const PraktikanIndex = ({
    ...
    const isAdmin = can("praktikan.create");
    ...
    const handleAssignKelas = (e) => {
        ...
        if (assignKelasForm.data.kelas_id) {
            assignKelasForm.put(
                route("praktikum.praktikan.assign-kelas", {
                    praktikum: praktikum.id,
            ...
            router.put(
                ...
                {},
                {
                    ...
                    onSuccess: () => {
                        toast.success(
                            "Praktikan berhasil dikeluarkan dari kelas",
                        );
                        closeAssignKelasModal();
                    },
                    onError: () => {
    ...
    const updateStatus = (praktikan, newStatus) => {
        router.put(
            route("praktikum.praktikan.update-status", {
                praktikan: praktikan.id,
            }),
            {
                status: newStatus,
            },
