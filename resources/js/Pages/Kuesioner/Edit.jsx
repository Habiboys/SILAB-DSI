                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label className="flex items-center">
                                ...
                                />
                                <span className="ml-2 text-gray-700">Aktif (Dapat diakses responden)</span>
                            </label>
                        </div>
                        ...
                        <div className="mb-4">
                            <label className="flex items-center">
                                ...
                                />
                                <span className="ml-2 text-gray-700 font-medium">Wajib Diisi (Responden tidak bisa akses menu lain sebelum mengisi)</span>
                            </label>
                        </div>
