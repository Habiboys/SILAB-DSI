...
export default function StrukturPermissionManager({
    jabatans,
    permissions,
    jabatanPermissions,
}) {
    ...
    const [selectedJabatan, setSelectedJabatan] = useState(
        jabatans[0]?.jabatan || null,
    );
    const [editingPermissions, setEditingPermissions] = useState(() => {
        const initial = {};
        const firstJabatan = jabatans[0]?.jabatan;
        if (firstJabatan) {
            (jabatanPermissions[firstJabatan] || []).forEach(
                (p) => (initial[p] = true),
            );
        }
        return initial;
    ...
    const savePermissions = () => {
        ...
        router.put(
            route("struktur-permissions.update", selectedJabatan),
            {
    ...
    const handleDeleteJabatan = (jabatan) => {
        if (
            !confirm(
                `Remove all permissions for '${jabatan}'? The jabatan itself will remain in Data Master.`,
            )
        )
            return;
                ...
                <div className="mb-6">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800">
                            Struktur Permission Manager
                        </h1>
                        <p className="text-gray-600">
                            Assign permissions to organizational positions.
                            ...
                            <div className="divide-y max-h-[600px] overflow-y-auto">
                                {jabatans.map((jab) => (
                                    <div
                                        key={jab.jabatan}
                                        onClick={() =>
                                            handleJabatanChange(jab.jabatan)
                                        }
                                        className={`p-4 cursor-pointer hover:bg-gray-50 ${
                                            selectedJabatan === jab.jabatan
                                            ...
                                            <div key={module} className="mb-6">
                                                <div className="flex items-center justify-between mb-3">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            ...
                                                            const inherited =
                                                                currentJabatanData?.inherited_permissions ||
                                                                [];
                                                            ...
                                                            if (
                                                                assignablePerms.length >
                                                                0
                                                            ) {
                                                                const allSelected =
                                                                    assignablePerms.every(
                                                                        (p) =>
                                                                            editingPermissions[
                                                                                p
                                                                                    .name
                                                ...
                                                <div className="grid grid-cols-2 gap-2">
                                                    {perms.map((permission) => {
                                                        ...
                                                        const isInherited =
                                                            currentJabatanData?.inherited_permissions?.includes(
                                                                permission.name,
                                                            );
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <div>
                                                                    <div className="flex items-center gap-2">
                                                                        <span
                                                                            className={`text-sm font-medium ${isInherited ? "text-gray-600" : "text-gray-700"}`}
                                                                        >
                                                                            {
                                                                                permission.label
                                                                            }
