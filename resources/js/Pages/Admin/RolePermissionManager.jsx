...
export default function RolePermissionManager({ roles, permissions, allPermissions }) {
    ...
    const savePermissions = () => {
        ...
        router.post(route('admin.roles.permissions.update', selectedRole.id), {
    ...
    const handleCreateRole = (e) => {
        ...
        router.post(route('admin.roles.create'), {
            name: newRoleName,
            permissions: []
        }, {
            onSuccess: () => {
        ...
        <DashboardLayout>
            ...
            <div className="p-6">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800">Role & Permission Manager</h1>
                                    ...
                                    {Object.entries(filteredPermissions).map(([module, perms]) => (
                                        <>
                                            <tr key={module} className="bg-gray-100">
                                                <td colSpan={roles.length + 1} className="px-6 py-2 font-semibold text-gray-700">
                                                    {module}
                                                </td>
                                            </tr>
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <div className="text-sm text-gray-500">{role.permissions_count} permissions</div>
                                            </div>
                                            {!['superadmin', 'kadep', 'admin', 'asisten', 'praktikan'].includes(role.name) && (
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                ...
                                                <div className="flex items-center justify-between mb-3">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            ...
                                                            const allSelected = perms.every(p => editingPermissions[p.name]);
                                                            perms.forEach(p => newState[p.name] = !allSelected);
                                                ...
                                                <div className="grid grid-cols-2 gap-2">
                                                    {perms.map(permission => (
                                                        ...
                                                        >
                                                            <input
                                                                type="checkbox"
                                                                checked={editingPermissions[permission.name] || false}
