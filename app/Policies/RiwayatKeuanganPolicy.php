...
class RiwayatKeuanganPolicy
{
     ...
     */
    public function view(User $user, RiwayatKeuangan $riwayatKeuangan): bool
    {
     ...
     */
    public function update(User $user, RiwayatKeuangan $riwayatKeuangan): bool
    {
        $labId = $riwayatKeuangan->kepengurusanLab->laboratorium_id ?? null;
     ...
     */
    public function delete(User $user, RiwayatKeuangan $riwayatKeuangan): bool
    {
