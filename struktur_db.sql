...
--
-- Host: localhost:3306
-- Generation Time: Apr 04, 2026 at 05:19 AM
...
CREATE TABLE `absensi` (
  ...
  `manual_input_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verification_status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'approved',
...
CREATE TABLE `disposisi_surat` (
  ...
  `dari_user_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kepada_user_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `catatan` text COLLATE utf8mb4_unicode_ci,
  `status` enum('belum_dibaca','sudah_dibaca','selesai') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'belum_dibaca',
...
CREATE TABLE `konfigurasi_surat` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kepengurusan_lab_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inisial_lab` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'LAB',
  `format_nomor` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '{nomor}/LAB.{inisial_lab}/{bulan_romawi}/{tahun}',
...
--
-- Table structure for table `lpj_kepengurusan`
--

CREATE TABLE `lpj_kepengurusan` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kepengurusan_lab_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `judul` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nomor_dokumen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('draft','review','disetujui','terkunci') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `ringkasan` text COLLATE utf8mb4_unicode_ci,
  `total_proker` int UNSIGNED NOT NULL DEFAULT '0',
  `proker_disetujui` int UNSIGNED NOT NULL DEFAULT '0',
  `proker_selesai` int UNSIGNED NOT NULL DEFAULT '0',
  `total_kegiatan` int UNSIGNED NOT NULL DEFAULT '0',
  `kegiatan_disetujui` int UNSIGNED NOT NULL DEFAULT '0',
  `total_laporan_kegiatan` int UNSIGNED NOT NULL DEFAULT '0',
  `total_dokumentasi_kegiatan` int UNSIGNED NOT NULL DEFAULT '0',
  `persentase_capaian_rata2` decimal(5,2) DEFAULT NULL,
...
CREATE TABLE `pemasukan_keuangan` (
  ...
  `jenis_pembayaran_kas` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `peminjaman_aset` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `detail_aset_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `proker_dokumentasi`
--

CREATE TABLE `proker_dokumentasi` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `proker_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `judul` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `surat_masuk` (
  ...
  `nomor_surat_asal` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `isi_ringkas` text COLLATE utf8mb4_unicode_ci,
  `file_surat` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `diterima_oleh` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `lpj_kepengurusan`
--
ALTER TABLE `lpj_kepengurusan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `lpj_kepengurusan_generated_by_foreign` (`generated_by`),
  ADD KEY `lpj_kepengurusan_approved_by_foreign` (`approved_by`),
  ADD KEY `lpj_kepengurusan_kepengurusan_lab_id_status_index` (`kepengurusan_lab_id`,`status`);
...
ALTER TABLE `peminjaman_aset`
  ADD PRIMARY KEY (`id`),
  ADD KEY `peminjaman_aset_detail_aset_id_foreign` (`detail_aset_id`),
...
--
-- Indexes for table `proker_dokumentasi`
--
ALTER TABLE `proker_dokumentasi`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proker_dokumentasi_proker_id_foreign` (`proker_id`),
  ADD KEY `proker_dokumentasi_uploaded_by_foreign` (`uploaded_by`);
...
ALTER TABLE `riwayat_kondisi_aset`
  ADD PRIMARY KEY (`id`),
  ADD KEY `riwayat_kondisi_aset_detail_aset_id_foreign` (`detail_aset_id`),
...
--
-- AUTO_INCREMENT for table `struktur_permissions`
--
ALTER TABLE `struktur_permissions`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `detail_aset`
--
ALTER TABLE `detail_aset`
...
--
ALTER TABLE `laporan_keuangan`
  ADD CONSTRAINT `laporan_keuangan_kepengurusan_lab_id_foreign` FOREIGN KEY (`kepengurusan_lab_id`) REFERENCES `kepengurusan_lab` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `lpj_kepengurusan`
--
ALTER TABLE `lpj_kepengurusan`
  ADD CONSTRAINT `lpj_kepengurusan_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `lpj_kepengurusan_generated_by_foreign` FOREIGN KEY (`generated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `lpj_kepengurusan_kepengurusan_lab_id_foreign` FOREIGN KEY (`kepengurusan_lab_id`) REFERENCES `kepengurusan_lab` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `peminjaman_aset`
  ADD CONSTRAINT `peminjaman_aset_detail_aset_id_foreign` FOREIGN KEY (`detail_aset_id`) REFERENCES `detail_aset` (`id`) ON DELETE CASCADE,
...
--
-- Constraints for table `proker_dokumentasi`
--
ALTER TABLE `proker_dokumentasi`
  ADD CONSTRAINT `proker_dokumentasi_proker_id_foreign` FOREIGN KEY (`proker_id`) REFERENCES `proker` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `proker_dokumentasi_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `riwayat_kondisi_aset`
  ADD CONSTRAINT `riwayat_kondisi_aset_detail_aset_id_foreign` FOREIGN KEY (`detail_aset_id`) REFERENCES `detail_aset` (`id`) ON DELETE CASCADE,
